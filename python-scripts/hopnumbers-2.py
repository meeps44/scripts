...
# Gets the number of hops between a source host and a destination node
                ...
                if (os.path.isfile(os.path.join(args.directory, file))):
                    with open(os.path.join(args.directory, file), 'r') as file:
                        ...
                        for item in data:
                            ...
                            print(f"Source: {item['source']} Destination: {item['destination']} Flowlabel: {item['flow_label']} Hopnumber: {number_of_hops}")
