        ...
        for flow_label in flow_label_list:
            ...
            for key in test_dict:
                if len(test_dict[key]) == 1:
                    ...
                    print(f"List of ASes traversed: {asn_list}")
                    print(f"List of unique ASes traversed: {unique_asn_list}")
                    print(f"Number of ASes traversed: {len(asn_list)}")
                    print(f"Number of unique ASes traversed: {len(unique_asn_list)}")
                if len(test_dict[key]) > 1:
